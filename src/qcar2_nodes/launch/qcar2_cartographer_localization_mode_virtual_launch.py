...
def generate_launch_description():
    ...
    configuration_basename_la = DeclareLaunchArgument(
            ...
            default_value='qcar2_2d_localization.lua',
    ...
    cartographer_node = Node(
            ...
            arguments=['-configuration_directory', cartographer_config_dir,
                       ...
                       '-load_state_filename', '/workspaces/isaac_ros-dev/ros2/qlabs_map.pbstream'])
    ...
    # remappings=[
    #         ('/qcar2_motor_speed_cmd', '/qcar2_motor_speed_cmd_DONOTUSE')
    #     ]
    # )
